...
class TeMonthlyPlan(SQLModel, table=True):
    ...
    lot_part_info : list[dict[str, Any]] | None = Field(default=None, sa_column=Column(JSONB)) #使用部品情報
